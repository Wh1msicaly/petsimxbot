...
Gui, Add, Text, x12 y339 w330 h20 , by whim#2127 | [> F3 <] To activate bot. | ver 1.0
...
Gui, Tab, 2
Gui, Add, Text, x262 y49 w70 h20 , %waitTime%ms
Gui, Add, Text, x22 y49 w240 h20 , wait|split check inbetween ms first frame
Gui, Add, Text, x22 y69 w240 h20 , exclusivly modifable via config
